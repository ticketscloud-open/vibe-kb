...
Obsidian сохранить все изменения в Git и отправит их в репозиторий. После [сборки](https://github.com/ticketscloud/vibe-kb/actions) обновленная база будет доступна по адресу: 