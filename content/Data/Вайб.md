...
| 10  | media                         | varchar(255) | Медиа (обложка) ?                          | —                                                                             |
| 11  | name                          | varchar(255) | Название                                   | Burning Woman                                                                 |
| 12  | start                         | timestamp    | Дата начала                                | 2019-08-01 07:00:00                                                           |
| 14  | meta                          | json         | Метаданные                                 | {}                                                                            |
| 15  | group_id                      | int4         | id группы мероприятий                      | 2                                                                             |
| 16  | city_id                       | varchar(10)  | id города                                  | 524901                                                                        |
| 17  | organizer_id                  | int4         | id организатора                            | 1                                                                             |
| 19  | state                         | varchar(10)  | Статус                                     | canceled / new / paused / published                                           |
| 21  | is_refundable                 | bool         | Возврат денег за билеты (default true)     | TRUE / FALSE                                                                  |
| 23  | is_transferable               | bool         | Разрешена передача (дарение) билета ?      | TRUE / FALSE                                                                  |
| 24  | resale_ready                  | bool         | Готово к перепродаже                       | TRUE / FALSE                                                                  |
| 25  | min_resale_price_ppm          | int4         | Минимальная цена перепродажи               | 0                                                                             |
| 26  | max_resale_price_ppm          | int4         | Максимальная цена перепродажи              | 0                                                                             |
| 27  | scan_mode                     | int4         | Режим сканирования                         | 10=Dynamic QR / 20=Static QR / 24=Static barcode / 25=Access code / 30=Manual |
| 29  | referral                      | int2         | Реферальные настройки ?                    | —                                                                             |
| 30  | org_commission                | int2         | Комиссия организатора                      | 50                                                                            |
| 32  | resale_free                   | bool         | Перепродажа бесплатных билетов ?           | TRUE / FALSE                                                                  |
| 34  | is_chat_available             | bool         | Доступен чат мероприятия                   | TRUE / FALSE                                                                  |
| 35  | timezone                      | varchar(255) | Часовой пояс                               | Europe/Vilnius                                                                |
| 37  | category                      | varchar(20)  | Категория мероприятия                      | ?                                                                             |
| 38  | org_media                     | varchar(255) | Медиа организатора ?                       | —                                                                             |
| 39  | hidden_date                   | bool         | Скрытая дата                               | TRUE / FALSE                                                                  |
| 40  | age_restriction               | int4         | Возрастное ограничение                     | —                                                                             |
| 41  | amount                        | int4         | Количество билетов ?                       | —                                                                             |
| 42  | price_min                     | int4         | Минимальная цена                           | —                                                                             |
| 43  | amount_vacant                 | int4         | Количество свободных билетов ?             | —                                                                             |
| 44  | rating                        | int4         | Рейтинг                                    | 0                                                                             |
| 45  | transfer_free                 | bool         | Бесплатная передача билета ?               | TRUE / FALSE                                                                  |
| 46  | pushcard                      | bool         | ?                                          | TRUE / FALSE                                                                  |
| 47  | hidden_feed                   | bool         | Скрыто из ленты                            | TRUE / FALSE                                                                  |
| 48  | system_                       | varchar(255) | Система                                    | PHANTOM / TC / TEST                                                           |
| 49  | sync                          | bool         | Синхронизация                              | TRUE / FALSE                                                                  |
| 50  | feed                          | bool         | В ленте                                    | TRUE / FALSE                                                                  |
| 51  | location_id                   | varchar(255) | id локации (площадка/ресторан из location) | —                                                                             |
| 52  | feed_add_at                   | timestamp    | Добавлено в ленту                          | —                                                                             |
| 53  | feed_remove_at                | timestamp    | Убрано из ленты                            | —                                                                             |
| 54  | show_chat_participants_number | bool         | Показывать число участников чата ?         | TRUE / FALSE                                                                  |
